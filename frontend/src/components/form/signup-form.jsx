...
const SignUpForm = () => {
  ...
  function createUserAcccount(e) {
    ...
    if (firstname.current.value === "" || lastname.current.value === "" || telephone.current.value === "" || email.current.value === "" || !password.current.value.match(passwordRegEx))
      return showToast(
        toast,
        "your fields are empty or Password must be minimum 8 characters, at least 1 letter and 1 number."
      );
